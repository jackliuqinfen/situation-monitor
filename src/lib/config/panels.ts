...
export const PANELS: Record<PanelId, PanelConfig> = {
	...
	commodities: { name: '大宗商品 / 恐慌指数', priority: 2 },
	crypto: { name: '加密货币', priority: 2 },
	polymarket: { name: '预测市场 (Polymarket)', priority: 2 },
	whales: { name: '巨鲸追踪', priority: 3 },
	mainchar: { name: '核心人物', priority: 2 },
	...
	intel: { name: '情报信息流', priority: 2 },
	correlation: { name: '相关性分析引擎', priority: 1 },
